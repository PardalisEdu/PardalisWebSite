                        ...
                        <div class="prose max-w-none">
                            ...
                            {#if section.title === "Términos generales"}
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Términos generales</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Licencia</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Definiciones y términos clave</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Política de Devolución y Reembolso</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Enlaces a otros Sitios web</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Cambios en nuestros Términos y Condiciones</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Modificaciones a nuestra plataforma</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Actualizaciones a nuestra plataforma</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Servicios de Terceros</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Duración y Terminación</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Aviso de infracción de Derechos de Autor</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Limitación de Responsabilidad</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Enmiendas a este Acuerdo</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Actualizaciones de nuestros Términos</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Propiedad intelectual</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Acuerdo de Arbitraje</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Envíos y Privacidad</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Errores Tipográficos</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    <h3 class="text-xl font-semibold mb-4">Descargo de Responsabilidad</h3>
                                    <p class="text-gray-700">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                    ...
                                    <ul>
                                        <li>
                                            A través de correo electrónico: garcia.garcia.oscar2376@gmail.com
                                        </li>
                                    </ul>
                                </div>
