...
<div class="relative min-h-screen flex flex-col overflow-hidden bg-[#FFFDF5] font-sans">
	...
	<main class="relative z-10 grid grid-cols-1 md:grid-cols-2 flex-1 max-w-7xl mx-auto w-full p-6 md:p-12 items-center">
		...
		<div class="relative flex justify-center items-center mt-12 md:mt-0">
			...
			<div class="absolute w-64 h-64 md:w-125 md:h-125 bg-yellow-400/10 rounded-full blur-3xl animate-pulse"></div>
...
<div class="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FFFDF5] font-sans py-20">
	...
	<section class="relative z-10 w-full max-w-7xl mx-auto px-6">
		...
		<!-- Grid de Tarjetas Estilo Flat 2.0 -->
		<div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
			
			<!-- Tarjeta 1: Herramienta (Ocupa 7 columnas en desktop) -->
			<div class="md:col-span-7 group bg-white p-8 md:p-12 rounded-[2.5rem] border-4 border-blue-200 shadow-[0_12px_0_0_#bfdbfe] hover:-translate-y-2 hover:shadow-[0_16px_0_0_#bfdbfe] transition-all duration-300 flex flex-col md:flex-row gap-8 items-center">
				<div class="shrink-0 w-32 h-32 bg-blue-100 rounded-4xl border-4 border-blue-300 shadow-[0_6px_0_0_#93c5fd] flex items-center justify-center text-6xl group-hover:rotate-6 transition-transform">
					🎒
				</div>
				<div>
			...
			<!-- Tarjeta 2: Situaciones Mexicanas (Ocupa 5 columnas en desktop) -->
			<div class="md:col-span-5 group bg-white p-8 md:p-10 rounded-[2.5rem] border-4 border-green-200 shadow-[0_12px_0_0_#bbf7d0] hover:-translate-y-2 hover:shadow-[0_16px_0_0_#bbf7d0] transition-all duration-300 flex flex-col justify-center relative overflow-hidden">
				<!-- Decoración de fondo -->
				<div class="absolute -right-10 -top-10 text-9xl opacity-10 rotate-12 group-hover:rotate-45 transition-transform duration-700">🌵</div>
			...
			<!-- Tarjeta 3: Amigable (Ocupa 12 columnas, centrada, como un banner grande) -->
			<div class="md:col-span-12 group bg-[#f9c710] p-8 md:p-14 rounded-[3rem] border-4 border-yellow-500 shadow-[0_16px_0_0_#d4a007] hover:-translate-y-2 hover:shadow-[0_20px_0_0_#d4a007] transition-all duration-300 mt-4 md:mt-8">
				<div class="flex flex-col md:flex-row items-center justify-between gap-10">
					...
					<div class="shrink-0 relative">
						<div class="w-40 h-40 bg-white rounded-[2.5rem] border-4 border-yellow-200 shadow-[0_8px_0_0_#fde047] flex items-center justify-center text-7xl group-hover:scale-110 transition-transform duration-300 z-10 relative">
							🎮
						</div>
						<!-- Estrellitas decorativas -->
						<div class="absolute -top-6 -right-6 text-4xl animate-bounce">✨</div>
						<div class="absolute -bottom-4 -left-8 text-3xl animate-pulse">⭐</div>
					</div>
				</div>
			</div>
