...
<div class="min-h-screen bg-gradient-to-b from-yellow-50 to-yellow-100 pt-24 px-4 py-10 mt-10">
                ...
                >
                    <div class="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
                        ...
                        <div class="relative h-full flex flex-col items-center justify-center p-6 text-white">
                            <span class="text-6xl mb-4 transform group-hover:scale-110 transition-transform">
                                {game.emoji}
                            </span>
                            ...
                            <div class="absolute top-4 right-4 px-3 py-1 bg-white bg-opacity-20 rounded-full text-xs font-medium">
                                {game.level}
                            </div>
                    ...
                    <div class="absolute -top-2 -right-2 w-8 h-8 bg-yellow-400 rounded-full transform rotate-12"></div>
                    <div class="absolute -bottom-2 -left-2 w-6 h-6 bg-yellow-300 rounded-full"></div>
                </button>
            {/each}
        </div>
        ...
        <div class="mt-12 text-center">
            ...
            <div class="bg-white rounded-xl p-6 shadow-lg">
                <p class="text-gray-600 mb-4">
                    Each game is designed to help you learn English while having fun with Mexican themes!
                </p>
